...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"mapLeaflet.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    var position = [loc.coordinates[1], loc.coordinates[0]];
    positions.push(position);
    L.marker(position).addTo(map).bindPopup("<h1>Day ".concat(loc.day, ": ").concat(loc.description, "</h1>"), {
      autoClose: false
    }).openPopup();
  });
  var bounds = L.latLngBounds(positions).pad(0.5);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Email was sent successfully! Please check your email inbox. This page will be redirected to the login page in a few seconds.');
            window.setTimeout(function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(session);
          stripe = Stripe('pk_test_51MVpSkJAl7U5yZWAeFQ30kH4aUjTEUQpxutLuH0VoeRMftEOJm68VtEllcqXwAgrlhcGrb5vDyGCZdOMlpbCAG8e00UiSqbMw5'); // 2) Create checkout form + chanre credit card
          _context.next = 8;
...
if (leaflet) {
  ...
  (0, _mapLeaflet.displayMap)(locations);
}
...
},{"./mapLeaflet":"mapLeaflet.js","./login":"login.js","./forgotpassword":"forgotpassword.js","./updateSettings":"updateSettings.js","./signup":"signup.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
